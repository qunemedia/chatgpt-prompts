...
$aTranslations = array(
	...
	'LONG_DESCRIPTION' => '"%s"의 "%s"에 대한 기사 긴 설명을 작성하십시오. - 도입부 없이, 최대 %s 단어와 한국어로 작성해 주세요.',
	'SHORT_DESCRIPTION' => '"%s"의 "%s"에 대한 기사 짧은 설명을 작성하십시오. - 도입부 없이, 최대 %s 단어와 한국어로 작성해 주세요.',
	'PRODUCT_SEARCHKEYS' => '"%s"의 "%s"에 대한 동의어를 크기, 부피, 리터, 수량, 브랜드/제조업체 또는 개별 제품 특성(예: 색상)을 포함하지 않고 중복되지 않는 쉼표로 구분된 CSV 목록을 작성하십시오. 한국어로 작성해 주세요.',
	'PRODUCT_ATTRIBUTES' => '"%s" 제품 (제조업체 SKU: %s)에 대해 다음 속성의 값을 "%s"에서 추출하고 이를 바탕으로 JSON을 작성하십시오. `null` 값은 null로 반환하십시오. 한국어로 작성해 주세요.',
	'CATGEORY_LONG_DESCRIPTION' => '"%s"의 "%s" 카테고리에 대한 긴 설명을 작성하십시오. - 도입부 없이, 최대 %s 단어와 한국어로 작성해 주세요.',
	'CATGEORY_SHORT_DESCRIPTION' => '"%s"의 "%s" 카테고리에 대한 짧은 설명을 작성하십시오. - 도입부 없이, 최대 255자 내로 한국어로 작성해 주세요.',
	'MANUFACTURER_LONG_DESCRIPTION' => '"%s"의 "%s" 제조업체에 대한 긴 설명을 작성하십시오. - 도입부 없이, 최대 %s 단어와 한국어로 작성해 주세요.',
	'MANUFACTURER_SHORT_DESCRIPTION' => '"%s"의 "%s" 제조업체에 대한 짧은 설명을 작성하십시오. - 도입부 없이, 최대 255자 내로 한국어로 작성해 주세요.',
	'VENDOR_SHORT_DESCRIPTION' => '"%s"의 "%s" 공급업체에 대한 짧은 설명을 작성하십시오. - 도입부 없이, 최대 255자 내로 한국어로 작성해 주세요.',
