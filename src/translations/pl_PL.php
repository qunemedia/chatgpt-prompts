...
$aTranslations = array(
	...
	'LONG_DESCRIPTION' => 'Utwórz długi opis artykułu dla "%s" z "%s". - Proszę bez wprowadzenia, maksymalnie %s słów i po polsku.',
	'SHORT_DESCRIPTION' => 'Utwórz krótki opis artykułu dla "%s" z "%s". - Proszę bez wprowadzenia, maksymalnie %s słów i po polsku.',
	'PRODUCT_SEARCHKEYS' => 'Utwórz rozdzielaną przecinkami listę synonimów CSV dla "%s" z "%s" bez wskazań rozmiaru, objętości, litrów lub ilości, bez marki/producenta lub indywidualnych cech produktu, takich jak kolor, bez duplikatów i po polsku.',
	'PRODUCT_ATTRIBUTES' => 'Spróbuj określić wartości dla następujących atrybutów artykułu "%s" (SKU producenta: %s) z "%s" i utwórz JSON; zwróć wartości, które są `null`, jako null i po polsku.',
	'CATGEORY_LONG_DESCRIPTION' => 'Utwórz długi opis kategorii dla "%s" z "%s". - Proszę bez wprowadzenia, maksymalnie %s słów i po polsku.',
	'CATGEORY_SHORT_DESCRIPTION' => 'Utwórz krótki opis kategorii dla "%s" z "%s". - Proszę bez wprowadzenia, maksymalnie 255 znaków i po polsku.',
	'MANUFACTURER_LONG_DESCRIPTION' => 'Utwórz długi opis producenta dla "%s" z "%s". - Proszę bez wprowadzenia, maksymalnie %s słów i po polsku.',
	'MANUFACTURER_SHORT_DESCRIPTION' => 'Utwórz krótki opis producenta dla "%s" z "%s". - Proszę bez wprowadzenia, maksymalnie 255 znaków i po polsku.',
	'VENDOR_SHORT_DESCRIPTION' => 'Utwórz krótki opis dostawcy dla "%s" z "%s". - Proszę bez wprowadzenia, maksymalnie 255 znaków i po polsku.',
