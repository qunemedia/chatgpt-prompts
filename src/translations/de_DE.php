...
$aTranslations = array(
    ...
    'LONG_DESCRIPTION' => 'Erstelle eine Artikel-Langbeschreibung für "%s" von "%s". - Und bitte ohne Intro, mit max. %s Wörtern und auf deutsch.',
    'SHORT_DESCRIPTION' => 'Erstelle eine Artikel-Kurzbeschreibung für "%s" von "%s". - Und bitte ohne Intro, mit max. %s Wörtern und auf deutsch.',
    'PRODUCT_SEARCHKEYS' => 'Erstelle eine kommaseparierte CSV-Liste von Synonymen für "%s" vom "%s" ohne Größen-, Volumen, Liter- oder Mengenangaben, ohne Marke/Hersteller oder individuelle Produktmerkmale wie Farbe und ohne Dopplungen und auf deutsch.',
    'PRODUCT_ATTRIBUTES' => 'Versuche für die folgenden Attribute, für den Artikel "%s" (Hersteller-SKU: %s) von "%s", Werten zu ermitteln und erstelle ein daraus einen JSON; Werte, die "unbekannt" sind als `null` zurückgeben und auf deutsch: ',
    'CATGEORY_LONG_DESCRIPTION' => 'Erstelle eine Kategorie-Langbeschreibung für "%s" von "%s". - Und bitte ohne Intro, mit max. %s Wörtern und auf deutsch.',
    'CATGEORY_SHORT_DESCRIPTION' => 'Erstelle eine Kategorie-Kurzbeschreibung für "%s" von "%s". - Und bitte ohne Intro, mit max. 255 Zeichen und auf deutsch.',
    'MANUFACTURER_LONG_DESCRIPTION' => 'Erstelle eine Marken-Langbeschreibung für "%s" von "%s". - Und bitte ohne Intro, mit max. %s Wörtern und auf deutsch.',
    'MANUFACTURER_SHORT_DESCRIPTION' => 'Erstelle eine Marken-Kurzbeschreibung für "%s" von "%s". - Und bitte ohne Intro, mit max. 255 Zeichen und auf deutsch.',
    'VENDOR_SHORT_DESCRIPTION' => 'Erstelle eine Hersteller-Kurzbeschreibung für "%s" von "%s". - Und bitte ohne Intro, mit max. 255 Zeichen und auf deutsch.',
