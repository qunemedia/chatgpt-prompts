...
$aTranslations = array(
    ...
    'CONTEXT_TRANSLATE' => 'Traduci le seguenti informazioni da "%s" in italiano - e per favore senza introduzione: %s',
    'CONTEXT_START' => '--- INIZIO DEL CONTESTO ---',
    'CONTEXT_END' => '--- FINE DEL CONTESTO ---',

	'LONG_DESCRIPTION' => 'Crea una descrizione lunga dell\'articolo per "%s" da "%s". - E per favore senza introduzione, con un massimo di %s parole e in italiano.',
	'SHORT_DESCRIPTION' => 'Crea una descrizione breve dell\'articolo per "%s" da "%s". - E per favore senza introduzione, con un massimo di %s parole e in italiano.',
	'PRODUCT_SEARCHKEYS' => 'Crea un elenco CSV di sinonimi separati da virgole per "%s" da "%s" senza indicazioni di dimensioni, volume, litri o quantità, senza marca/produttore o caratteristiche individuali del prodotto come il colore, senza duplicati e in italiano.',
	'PRODUCT_ATTRIBUTES' => 'Cerca di determinare i valori per i seguenti attributi per l\'articolo "%s" (Codice produttore: %s) da "%s" e crea un JSON da essi; restituisci i valori che sono `null` come null e in italiano.',
	'CATGEORY_LONG_DESCRIPTION' => 'Crea una descrizione lunga della categoria per "%s" da "%s". - E per favore senza introduzione, con un massimo di %s parole e in italiano.',
	'CATGEORY_SHORT_DESCRIPTION' => 'Crea una descrizione breve della categoria per "%s" da "%s". - E per favore senza introduzione, con un massimo di 255 caratteri e in italiano.',
	'MANUFACTURER_LONG_DESCRIPTION' => 'Crea una descrizione lunga del produttore per "%s" da "%s". - E per favore senza introduzione, con un massimo di %s parole e in italiano.',
	'MANUFACTURER_SHORT_DESCRIPTION' => 'Crea una descrizione breve del produttore per "%s" da "%s". - E per favore senza introduzione, con un massimo di 255 caratteri e in italiano.',
	'VENDOR_SHORT_DESCRIPTION' => 'Crea una descrizione breve del fornitore per "%s" da "%s". - E per favore senza introduzione, con un massimo di 255 caratteri e in italiano.',
