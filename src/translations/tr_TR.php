...
$aTranslations = array(
    ...
    'PRODUCT_SEARCHKEYS' => '"%s" için "%s" dan virgülle ayrılmış bir CSV eşanlamlı listesi oluşturun, boyut, hacim, litre veya miktar belirtilmeden, marka/üretici veya renk gibi bireysel ürün özellikleri olmadan ve tekrarlamadan.',
    'PRODUCT_ATTRIBUTES' => '"%s" ürünü için (Üretici SKU: %s) %s den gelen aşağıdaki özelliklerin değerlerini belirlemeye çalışın ve bundan bir JSON oluşturun; `null` olan değerleri null olarak döndürün: ',
    'CATGEORY_LONG_DESCRIPTION' => '"%s" için "%s" kategorisinin uzun bir açıklamasını oluşturun. - Ve lütfen bir giriş olmadan ve maksimum %s kelime ile.',
    'CATGEORY_SHORT_DESCRIPTION' => '"%s" için "%s" kategorisinin kısa bir açıklamasını oluşturun. - Ve lütfen bir giriş olmadan ve maksimum 255 karakter ile.',
    'MANUFACTURER_LONG_DESCRIPTION' => '"%s" için "%s" üreticisinin uzun bir açıklamasını oluşturun. - Ve lütfen bir giriş olmadan ve maksimum %s kelime ile.',
